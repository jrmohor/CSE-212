...
# Test 1
# Scenario: Adding and removing nodes from the priority queue with different priorities.
# Expected Result: The nodes are removed from the queue in order of their priority,
# with the highest priority node being removed first.
...
# Test 2
# Scenario: Scenario: Adding with the same priority to the queue and then dequeuing them.
# Expected Result: The nodes are removed in order, even if they have the same priority.
